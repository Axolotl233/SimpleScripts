...
my $config = shift;
$config //= "/home/wenjie/code/wgdi/wgdi.total.conf.brachy";
...
#Rscript ~/code/wgdi/wgdi.anc.prepare.R $sp2.wgdi.lens 0
cp /home/wenjie/code/wgdi/z.Barb_G_hap1.wgdi.anc.txt Barb_G_hap1.wgdi.anc.txt
perl ~/code/wgdi/wgdi.block.ks_filter.pl $sps.blockinfo.csv 20 0 0.2 > $sps.blockinfo.cor.csv
